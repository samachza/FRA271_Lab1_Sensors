...
## Generated on : Wed Oct 15 09:38:23 2025
...
START_DIR                 = C:/cppep2/FRA271_Lab1_Sensors
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
DEFINES_ = -DMW_TIM3_ENCODER_VAR=mw_tim3 -DMW_TIM4_ENCODER_VAR=mw_tim4 -DMW_TIM1_ENCODER_VAR=mw_tim1 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DUSE_FULL_LL_DRIVER -DSTM32G474xx -DUSE_HAL_DRIVER -DMW_TIMEBASESOURCE=TIM2 -DMW_CONNECTIVITY_UART=LPUART1_BASE -DMW_CONNECTIVITY_RX_DMA=DMA1 -DMW_LPUART1_RX_DMA_STREAM=1 -DMW_LPUART1_RX_DMA_ENABLED=DMA1_Channel1_IRQHandler -DMW_CONNECTIVITY_RX_DMAStream=LL_DMA_CHANNEL_1 -DMW_CONNECTIVITY_RX_BUFFER=GET_LPUART1_RECEIVE_BUFFER -DMW_LPUART1_RECEIVE_BUFFER_SIZE=1024 -DMW_LPUART1_ENABLED=1 -DMW_GPIO_BIT_SHIFT=0 -DMW_CubeMXVersion_6.15.0
...
DEFINES_STM32DEVICEDRIVERBLOCKS = -DMW_TIM3_ENABLED=1 -DMW_TIM4_ENABLED=1 -DMW_TIM1_ENABLED=1
...
LDFLAGS_SKIPFORSIL = -mcpu=cortex-m4 -mthumb -mlittle-endian -mthumb-interwork -mfpu=fpv4-sp-d16 -mfloat-abi=hard --entry Reset_Handler --specs=nosys.specs  -T "C:\cppep2\FRA271_Lab1_Sensors\Encoder_reader\STM32CubeIDE\STM32G474RETX_FLASH.ld" --specs=nano.specs
...
SHAREDLIB_LDFLAGS_SKIPFORSIL = -mcpu=cortex-m4 -mthumb -mlittle-endian -mthumb-interwork -mfpu=fpv4-sp-d16 -mfloat-abi=hard --entry Reset_Handler --specs=nosys.specs  -T "C:\cppep2\FRA271_Lab1_Sensors\Encoder_reader\STM32CubeIDE\STM32G474RETX_FLASH.ld" --specs=nano.specs
...
CPP_LDFLAGS_SKIPFORSIL = -mcpu=cortex-m4 -mthumb -mlittle-endian -mthumb-interwork -mfpu=fpv4-sp-d16 -mfloat-abi=hard --entry Reset_Handler --specs=nosys.specs  -T "C:\cppep2\FRA271_Lab1_Sensors\Encoder_reader\STM32CubeIDE\STM32G474RETX_FLASH.ld" --specs=nano.specs
...
CPP_SHAREDLIB_LDFLAGS_SKIPFORSIL = -mcpu=cortex-m4 -mthumb -mlittle-endian -mthumb-interwork -mfpu=fpv4-sp-d16 -mfloat-abi=hard --entry Reset_Handler --specs=nosys.specs  -T "C:\cppep2\FRA271_Lab1_Sensors\Encoder_reader\STM32CubeIDE\STM32G474RETX_FLASH.ld" --specs=nano.specs
