...
## Generated on : Wed Jul 30 14:33:31 2025
...
START_DIR                 = D:/Fibo/Year3/TA_RMX/FRA271_Lab1_Sensors
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
OBJS = stm_timer_ll.o xcp_ext_mode.o Encoder_reader_simulink.o rtGetInf.o rt_nonfinite.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o overrideHALDelay.o platform_timer.o SysTickScheduler.o m3m4m4f_multitasking.o rtiostream_serial.o stm_usart.o stm_lpuart.o sys_arch.o main.o stm32g4xx_it.o stm32g4xx_hal_msp.o stm32g4xx_hal_timebase_tim.o stm32g4xx_ll_utils.o stm32g4xx_ll_exti.o stm32g4xx_hal_tim.o stm32g4xx_hal_tim_ex.o stm32g4xx_ll_gpio.o stm32g4xx_ll_dma.o stm32g4xx_ll_lpuart.o stm32g4xx_ll_rcc.o stm32g4xx_ll_pwr.o stm32g4xx_hal.o stm32g4xx_hal_rcc.o stm32g4xx_hal_rcc_ex.o stm32g4xx_hal_flash.o stm32g4xx_hal_flash_ex.o stm32g4xx_hal_flash_ramfunc.o stm32g4xx_hal_gpio.o stm32g4xx_hal_exti.o stm32g4xx_hal_dma.o stm32g4xx_hal_dma_ex.o stm32g4xx_hal_pwr.o stm32g4xx_hal_pwr_ex.o stm32g4xx_hal_cortex.o stm32g4xx_ll_tim.o system_stm32g4xx.o syscalls.o sysmem.o startup_stm32g474retx.o
...
LDFLAGS_SKIPFORSIL = -mcpu=cortex-m4 -mthumb -mlittle-endian -mthumb-interwork -mfpu=fpv4-sp-d16 -mfloat-abi=hard --entry Reset_Handler --specs=nosys.specs  -T"D:\Fibo\Year3\TA_RMX\FRA271_Lab1_Sensors\Encoder_reader\STM32CubeIDE\STM32G474RETX_FLASH.ld"
...
SHAREDLIB_LDFLAGS_SKIPFORSIL = -mcpu=cortex-m4 -mthumb -mlittle-endian -mthumb-interwork -mfpu=fpv4-sp-d16 -mfloat-abi=hard --entry Reset_Handler --specs=nosys.specs  -T"D:\Fibo\Year3\TA_RMX\FRA271_Lab1_Sensors\Encoder_reader\STM32CubeIDE\STM32G474RETX_FLASH.ld"
...
CPP_LDFLAGS_SKIPFORSIL = -mcpu=cortex-m4 -mthumb -mlittle-endian -mthumb-interwork -mfpu=fpv4-sp-d16 -mfloat-abi=hard --entry Reset_Handler --specs=nosys.specs  -T"D:\Fibo\Year3\TA_RMX\FRA271_Lab1_Sensors\Encoder_reader\STM32CubeIDE\STM32G474RETX_FLASH.ld"
...
CPP_SHAREDLIB_LDFLAGS_SKIPFORSIL = -mcpu=cortex-m4 -mthumb -mlittle-endian -mthumb-interwork -mfpu=fpv4-sp-d16 -mfloat-abi=hard --entry Reset_Handler --specs=nosys.specs  -T"D:\Fibo\Year3\TA_RMX\FRA271_Lab1_Sensors\Encoder_reader\STM32CubeIDE\STM32G474RETX_FLASH.ld"
...
%.o : $(START_DIR)/Encoder_reader_simulink_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Encoder_reader_simulink_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Encoder_reader_simulink_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Encoder_reader_simulink_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Encoder_reader_simulink_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Encoder_reader_simulink.o : $(START_DIR)/Encoder_reader_simulink_ert_rtw/Encoder_reader_simulink.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Encoder_reader_simulink_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/Encoder_reader_simulink_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/Encoder_reader_simulink_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
main.o : $(START_DIR)/Encoder_reader/Core/Src/main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_it.o : $(START_DIR)/Encoder_reader/Core/Src/stm32g4xx_it.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_hal_msp.o : $(START_DIR)/Encoder_reader/Core/Src/stm32g4xx_hal_msp.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_hal_timebase_tim.o : $(START_DIR)/Encoder_reader/Core/Src/stm32g4xx_hal_timebase_tim.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_ll_utils.o : $(START_DIR)/Encoder_reader/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_utils.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_ll_exti.o : $(START_DIR)/Encoder_reader/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_exti.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_hal_tim.o : $(START_DIR)/Encoder_reader/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_tim.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_hal_tim_ex.o : $(START_DIR)/Encoder_reader/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_tim_ex.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_ll_gpio.o : $(START_DIR)/Encoder_reader/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_gpio.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_ll_dma.o : $(START_DIR)/Encoder_reader/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_dma.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_ll_lpuart.o : $(START_DIR)/Encoder_reader/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_lpuart.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_ll_rcc.o : $(START_DIR)/Encoder_reader/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_rcc.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_ll_pwr.o : $(START_DIR)/Encoder_reader/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_pwr.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_hal.o : $(START_DIR)/Encoder_reader/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_hal_rcc.o : $(START_DIR)/Encoder_reader/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_rcc.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_hal_rcc_ex.o : $(START_DIR)/Encoder_reader/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_rcc_ex.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_hal_flash.o : $(START_DIR)/Encoder_reader/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_hal_flash_ex.o : $(START_DIR)/Encoder_reader/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_hal_flash_ramfunc.o : $(START_DIR)/Encoder_reader/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ramfunc.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_hal_gpio.o : $(START_DIR)/Encoder_reader/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_gpio.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_hal_exti.o : $(START_DIR)/Encoder_reader/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_exti.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_hal_dma.o : $(START_DIR)/Encoder_reader/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_dma.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_hal_dma_ex.o : $(START_DIR)/Encoder_reader/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_dma_ex.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_hal_pwr.o : $(START_DIR)/Encoder_reader/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pwr.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_hal_pwr_ex.o : $(START_DIR)/Encoder_reader/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pwr_ex.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_hal_cortex.o : $(START_DIR)/Encoder_reader/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_cortex.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_ll_tim.o : $(START_DIR)/Encoder_reader/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_tim.c
	$(CC) $(CFLAGS) -o "$@" "$<"


system_stm32g4xx.o : $(START_DIR)/Encoder_reader/Core/Src/system_stm32g4xx.c
	$(CC) $(CFLAGS) -o "$@" "$<"


syscalls.o : $(START_DIR)/Encoder_reader/STM32CubeIDE/Application/User/Core/syscalls.c
	$(CC) $(CFLAGS) -o "$@" "$<"


sysmem.o : $(START_DIR)/Encoder_reader/STM32CubeIDE/Application/User/Core/sysmem.c
	$(CC) $(CFLAGS) -o "$@" "$<"


startup_stm32g474retx.o : $(START_DIR)/Encoder_reader/STM32CubeIDE/Application/User/Startup/startup_stm32g474retx.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
